...
IMG_DOCTOR.src = 'photo/hero/doctor.png';
...
const CHANGELOG = [
  { version:'v1.3.6', date:'2026-05-03', items:[
    '完全移除開局選武器介面（o-weapsel overlay + 全部 JS 代碼）',
    '選完職業直接進入遊戲',
    '波次商店底部新增武器格子管理區（6格）',
    '  空格顯示灰色虛線框，有武器顯示圖片+名稱+品質色',
    '  同種同品質：拖拽自動融合升一級（✨ 可融合提示）',
    '  不同種/品質：拖拽互換位置；拖至空格：移動到該位置',
    '  拖拽開始：右下角出現垃圾桶圖示；拖至垃圾桶：賣出75%貝殼',
    '商店卡片左上角新增鎖頭（🔓/🔒）：',
    '  鎖定後刷新商店時該卡片保留在原位不被替換',
    '  購買後自動解鎖',
  ]},
  { version:'v1.3.5', date:'2026-05-03', items:[
    '起始武器品質固定為白色（普通），移除幸運值影響',
    '起始武器選擇畫面暫時繞過：選完職業直接進入遊戲（TODO 標記，待確認後恢復）',
  ]},
  { version:'v1.3.4', date:'2026-05-03', items:[
    '醫療箱傷害判定改為：以玩家為圓心 50px AoE，揮砍期間範圍內所有敵人受傷（_hits 防重複）',
    '醫生圖片修復：IMG_DOCTOR.src = "photo/hero/doctor.png"（棄用舊 IMG_SRC_DOCTOR base64）',
    '醫生渲染修正：imageSmoothingEnabled=true + quality=high，繪製高度改為 44px',
  ]},
